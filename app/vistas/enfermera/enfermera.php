...
<nav class="side-navbar fixed-top p-0 m-0">
      <div class="side-navbar-wrapper ">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          <!-- User Info-->
          <div class="sidenav-header-inner text-center text-white"><img src="<?=RUTA_URL?>img/<?=$_SESSION[$_COOKIE["PHPSESSID"]]['imagen'];?>" alt="person" class="rounded-circle img">
            <h2 class="h5"><?=$_SESSION[$_COOKIE["PHPSESSID"]]['nombre']?></h2><span class="text-white font-weight-bold">Enfermera/o</span>
          </div>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            <li><a href="<?=RUTA_URL?>enfermera/vistaConsultar"> <i class="icon-home"></i>Inicio</a></li>
            <li><a href="<?=RUTA_URL?>enfermera/justificaciones"><i class="fa fa-user-o" aria-hidden="true"></i>Justificación</a></li>
        ...
        <nav class="navbar" >
          <div class="container-fluid">
            ...
            <div class="navbar-header p-1"  style="background:rgba(255,175,75,1)!important;">
                   <a id="toggle-btn" class="menu-btn ocul w-100" onclick="ms('Enfermera')">
