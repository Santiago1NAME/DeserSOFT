      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-inner text-center text-white"><img src="<?=RUTA_URL?>img/<?=$_SESSION[$_COOKIE["PHPSESSID"]]['imagen'];?>" alt="person" class="img-fluid rounded-circle img">
            <h2 class="h5"><?=$_SESSION[$_COOKIE["PHPSESSID"]]['nombre']?></h2><span class="text-white font-weight-bold">Coordinador/a</span>
          </div>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            <li><a href="<?=RUTA_URL?>coordinador/vistaConsultar"> <i class="fa fa-home"></i>Inicio</a></li>
            <li><a href="<?=RUTA_URL?>coordinador/usuarios"><i class="fa fa-user" aria-hidden="true"></i> Usuarios</a></li>
            <li><a href="<?=RUTA_URL?>coordinador/vistaProgramas"><i class="fa fa-address-book"></i> Programas</a></li>
            <li><a href="<?=RUTA_URL?>coordinador/deserciones"><i class="fa fa-user-times"></i> Deserciones</a></li>
        ...
        <div class="container-fluid">
          <div class="navbar-holder d-flex align-items-center justify-content-between" style="background: rgba(138, 132, 132, 0.19)!important;">
            <div class="navbar-header p-1"  style="background:rgba(255,175,75,1)!important;">
                  <a id="toggle-btn" class="menu-btn ocul w-100" onclick="ms('Coordinador')">
